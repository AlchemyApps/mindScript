 ...
 *
 * Usage:
 *   ADMIN_EMAIL=admin@example.com ADMIN_PASSWORD=securepassword node scripts/seed-admin.mjs
 */
...
if (!ADMIN_EMAIL || !ADMIN_PASSWORD) {
  ...
  Example:
    ADMIN_EMAIL=admin@mindscript.com ADMIN_PASSWORD=MySecureP@ssw0rd! node scripts/seed-admin.mjs`);
  process.exit(1);
}
