    ...
    return (
      <button
        className={cn(
          ...
          // Variants
          {
            "bg-primary text-white hover:opacity-90 focus:ring-primary/50": variant === "primary",
            "bg-surface border border-gray-200 text-text hover:bg-gray-50 focus:ring-primary/50": variant === "secondary",
